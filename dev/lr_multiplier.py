"""
This code was downloaded from https://github.com/stante/keras-contrib/blob/feature-lr-multiplier/keras_contrib/optimizers/lr_multiplier.py
Authored by Alexander Stante <stante@gmail.com>
